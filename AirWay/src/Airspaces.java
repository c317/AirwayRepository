    ...
    public static class AirspacesController implements ActionListener
    {
        ...
        public void doLoadDemoAirspaces()
        {
            ...
            route.setLocations(Arrays.asList(
                ...
                LatLon.fromDegrees(43.0, -115.0)));
            route.setTerrainConforming(false, false);
            route.setValue(AVKey.DISPLAY_NAME, "my route");
            ...
            track.setValue(AVKey.DISPLAY_NAME, "my track 1");
            airspaces.add(track);
            ...
            track.setValue(AVKey.DISPLAY_NAME, "my track 2");
